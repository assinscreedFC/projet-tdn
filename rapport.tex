...
\begin{titlepage}
    ...
    % ASSUREZ-VOUS QUE 'UdP.jpg' EST DANS LE DOSSIER
    \includegraphics[width=0.4\textwidth]{UdP.jpg}
    
    \vspace{2cm}
    
    {\Huge \textbf{Projet TND - Analyse des céréales }}
   \vspace{0.5cm}

   
    {\Large \textbf{Trinome 5}} 
    
    \vspace{0.5cm}
    
    \vfill % Pousse le reste vers le bas
    
    {\Large \textbf{Membre du projet :} \par Danil GUIDJOU \par Yanis HAMMAOUI \par Anis HAMMOUCHE}
    ...
    {\large Licence Informatique et Application (L3)}
...
{\centering \includegraphics[width=0.7\linewidth]{output/figures/07_cercle_correlations_12} 
...
{\centering \includegraphics[width=0.7\linewidth]{output/figures/14_profils_cah} 
...
{\centering \includegraphics[width=0.8\linewidth]{output/figures/19_acp_clusters_kmeans} 
...
{\centering \includegraphics[width=0.6\linewidth]{output/figures/21_silhouette_kmeans} 
